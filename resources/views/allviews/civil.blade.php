...
@section('info')
	<div class="column content" >
		<h3 class="title is-3">Department of Civil Engieering</h3>
		<p>
...
@section('contact')
	<aside class="content">
		<p class="is-small"><em><strong>HOD</strong></em><br>Dr.Kyaw Moe Aung(Ph.D)<br><strong>Email:</strong><br>kyawmoeaung07@gmail.com<br>
		<strong>Rector Office:</strong><br><strong>Ph:</strong> (95)-2-57360<br><strong>FAX:</strong>
	096502601</p>
	</aside>
@endsection