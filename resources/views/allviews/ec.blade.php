...
<div class="column content">
	<h3 class="title is-3">Department of Electronic Engineering</h3>
	<p>
	...
	<h4 class="title is-4">Mission and Vission</h4>
		<p>
			...
			<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To impart knowledge in Electronic Science and Technology to meet the international standards and make the Electronic Engineering ethically and emotionally strong enough to meet the technological challenges for the well being of this country in the coming years.
 </p>
	...
	<h4 class="title is-4">Courses</h4>
		...
		<p><strong>Division of Control Engineering</strong></p>
		<ul>
		...
		<p><strong>Division of Communication Engineering</strong></p>
		<ul>
		...
		<p><strong>Division of Signal Processing Engineering</strong></p>
		<ul>
		...
		<p><strong>Division of Computer Network Engineering</strong></p>
		<ul>
		...
		<p><strong>Division of Microelectronics and Embedded Technology</strong></p>
		<ul>
...
@section('contact')
	<aside class="content">
		<p class="is-small"><em><strong>HOD</strong></em><br>Dr.Hla Myo Htun<br><strong>Email:</strong><br>ee.mtu.mdy@gmail.com<br>
		<strong>Rector Office</strong><br><strong>Ph:</strong> (95)-9-33064260<br><strong>FAX:</strong>(95)-257361</p>
	</aside>
@endsection