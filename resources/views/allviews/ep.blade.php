...
<div class="column content">
	<h3 class="title is-3">Department of Electrical Power Engineering</h3>
	<p>
	...
	<p>
		...
		<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;To impart knowledge in electrical technology to meet the international standards and make the electrical engineering ethically and emotionally strong enough to meet the technological challengers for the well being of our country in coming years.
	</p>
...
@section('contact')
	<aside class="content">
		<p class="is-small"><em><strong>HOD</strong></em><br>Dr.Khin Thuzar Soe<br><strong>Email:</strong><br>
		<strong>Rector Office:</strong><br><strong>Ph:</strong><br><strong>FAX:</strong></p>
	</aside>
@endsection